...
export default {
  install( Vue ){
    ...
    Vue.prototype.createElement = function () {
      ...
      str+= '<div class="crop_loading"><div class="crop_content"><img src="../../static/img/loading.gif"><div class="crop_text">图片上传中</div></div></div>';
    ...
    Vue.prototype.crop  = function () {
      ...
      setTimeout(function () {
        ...
        axios
        .post(
          "https://airadar.qhfkj.top/commons/uploads/",
          qs.stringify({
            img: imgData
          })
        )
    ...
    Vue.prototype.postImg = function( imageData ) {
      ...
      window.setTimeout( function () {
        console.log(document.querySelector('.crop_loading'));
